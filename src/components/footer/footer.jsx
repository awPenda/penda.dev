const Footer = () => {
    return(
        <div id="Footer" class="pt-16 pb-24">
            {/*<ul>
                <li>Home</li> {/ *<!--Cover-->* /}
                <li>About Me</li> {/ *<!--Intro + open to display experiences / or button to send to resume -->* /}
                <li>Goals</li> {/ *<!--ProfessionalGoalsPFI-->* /}
            ...
            */}
            ...
            <ul class="flex flex-row justify-evenly mt-16">
                    <li>
